...
# 图片根目录
root = 'C:/Remote sensing semantic segmentation/ISPRSVaihingen/Val/mask_vis/'
save_root = 'C:/Remote sensing semantic segmentation/ISPRSVaihingen/Val/mask/'  # 存放新图片的路径
