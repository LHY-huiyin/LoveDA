...
# 原图和标签
image_root = "C:/Remote sensing semantic segmentation/ISPRSVaihingen/Train/image/"  # 要改变的图片的路径文件夹
image_save = "C:/Remote sensing semantic segmentation/ISPRSVaihingen/Train/image_aug/"  # 要保存的图片的路径文件夹
label_root = "C:/Remote sensing semantic segmentation/ISPRSVaihingen/Train/mask/"
label_save = "C:/Remote sensing semantic segmentation/ISPRSVaihingen/Train/mask_aug/"
