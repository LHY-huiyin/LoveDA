...
# 图片根目录
root = 'C:/Remote sensing semantic segmentation/ISPRSVaihingen/Train/mask_vis/'
save_root = 'C:/Remote sensing semantic segmentation/ISPRSVaihingen/Train/mask/'  # 存放新图片的路径
