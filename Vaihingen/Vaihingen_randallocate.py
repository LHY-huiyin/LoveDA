...
tifFilePath = r'C:\\Remote sensing semantic segmentation\\ISPRSVaihingen\\Image\\'
saveBasePath = r"C:\\Remote sensing semantic segmentation\\ISPRSVaihingen\\randomgroup\\"

trainval_percent = 1  # trainval_percent=0.9# 表示余下的百分之十用于test
train_percent = 0.5  # train_percent=1 # 表示训练集中用于训练，没有用于验证
