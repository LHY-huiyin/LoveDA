    ...
    train=dict(
        ...
        params=dict(
            image_dir=[#训练集的路径
                ...
                'G:/datasets/LoveDA/Train/Urban/images_png/',
                'G:/datasets/LoveDA/Train/Rural/images_png/'
            ],
            mask_dir=[
                # './LoveDA/Train/Urban/masks_png/',
                # './LoveDA/Train/Rural/masks_png/',
                'G:/datasets/LoveDA/Train/Urban/masks_png/',
                'G:/datasets/LoveDA/Train/Rural/masks_png/'
            ],
    ...
    test=dict(
        ...
        params=dict(
            image_dir=[
                ...
                'G:/datasets/LoveDA/Val/Urban/images_png/',
                'G:/datasets/LoveDA/Val/Rural/images_png/'
            ],
            mask_dir=[
                # './LoveDA/Val/Urban/masks_png/',
                # './LoveDA/Val/Rural/masks_png/',
                'G:/datasets/LoveDA/Val/Urban/masks_png/',
                'G:/datasets/LoveDA/Val/Rural/masks_png/'
            ],
            transforms=Compose([
                Normalize(mean=(123.675, 116.28, 103.53),
                          std=(58.395, 57.12, 57.375),
