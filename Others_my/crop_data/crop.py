...
#     for i in range(4):
#         for j in range(4):
#             img3_ = img3[256 * i: 256 * (i + 1), 256 * j: 256 * (j + 1), :]
#
#             name_ = i * 4 + j
#             # 让RGB图像和标签图像的文件名对应
#             name_ = str(name_)
