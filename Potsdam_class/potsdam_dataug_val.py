...
# 原图和标签
image_root = "H:\\datasets\\Vovpotsdam\\Val\\image\\"  # 要改变的图片的路径文件夹
image_save = "H:\\datasets\\Vovpotsdam\\Val\\image_aug\\"  # 要保存的图片的路径文件夹
label_root = "H:\\datasets\\Vovpotsdam\\Val\\mask\\"
label_save = "H:\\datasets\\Vovpotsdam\\Val\\mask_aug\\"
